 ...
 *
 * Object-Relational Mapping for {@link HHFollowRequest}
 */
public class ORMFollowRequest {
	...
	public static String REQUESTED_USER_ID() { return COLUMN_REQUESTED_USER_ID_NAME; }
	public static String dotREQUESTED_USER_ID() { return TABLE_NAME + "." + COLUMN_REQUESTED_USER_ID_NAME; }
